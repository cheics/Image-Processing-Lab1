...
\centering
	...
	\subfigure[Phase Lena Image (Log of Phase)]{
...
The original image Fourier spectra are represented as a horizontal sinc function 90 degrees to the vetical rectangle in the image. When the original image is rotated 45 degrees, the horizontal spectra components that made up the original image spectra became a combinatoin of vertical and horizontal spectra. When the image was rotated, the frequency components of the image also rotated; therefore the spectra is a rotated version of the original image spectra.
